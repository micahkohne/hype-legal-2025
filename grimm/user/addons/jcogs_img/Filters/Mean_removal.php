 ...
 * An Mean Removal filter.
 */
class Mean_removal implements FilterInterface
{
    /**
     * Constructs Mean Removal filter.
     *
     */
    ...
    public function apply(ImageInterface $image): ImageInterface
    {
        ...
        switch (true) {
            case ($image instanceof \Imagine\Gd\Image) : 
                $image = (new \JCOGSDesign\Jcogs_img\Filters\Gd\Mean_removal())->apply($image);
                break;
