...
namespace BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\Command;

use BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\Config\Config;
use BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\Config\ConfigFactory;
use BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\ApplicationFactory\FreshInstanceApplicationFactory;
use BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\Input\BinInputFactory;
use BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\Logger;
use BoldMinded\Carson\Dependency\Bamarni\Composer\Bin\ApplicationFactory\NamespaceApplicationFactory;
use BoldMinded\Carson\Dependency\Composer\Command\BaseCommand;
use BoldMinded\Carson\Dependency\Composer\Factory;
use BoldMinded\Carson\Dependency\Composer\IO\IOInterface;
use BoldMinded\Carson\Dependency\Composer\IO\NullIO;
use BoldMinded\Carson\Dependency\Symfony\Component\Console\Application;
use BoldMinded\Carson\Dependency\Symfony\Component\Console\Input\InputArgument;
...
class BinCommand extends BaseCommand
{
    ...
    public function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $composer = method_exists($this, 'requireComposer') ? $this->requireComposer() : $this->getComposer();
