...
use BoldMinded\Carson\Dependency\Http\Promise\Promise;
use BoldMinded\Carson\Dependency\Psr\Http\Message\RequestInterface as Psr7RequestInterface;
...
use BoldMinded\Carson\Dependency\Symfony\Component\HttpClient\Response\StreamableInterface;
use BoldMinded\Carson\Dependency\Symfony\Component\HttpClient\Response\StreamWrapper;
...
final class HttplugWaitLoop
{
    ...
    public function wait(?ResponseInterface $pendingResponse, ?float $maxDuration = null, ?float $idleTimeout = null) : int
    {
        ...
        $guzzleQueue = \BoldMinded\Carson\Dependency\GuzzleHttp\Promise\Utils::queue();
