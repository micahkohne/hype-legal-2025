 ...
 */
namespace BoldMinded\Carson\Dependency\Symfony\Component\HttpClient;

use BoldMinded\Carson\Dependency\GuzzleHttp\Promise\Promise as GuzzlePromise;
use BoldMinded\Carson\Dependency\GuzzleHttp\Promise\RejectedPromise;
use BoldMinded\Carson\Dependency\GuzzleHttp\Promise\Utils;
use BoldMinded\Carson\Dependency\Http\Client\Exception\NetworkException;
use BoldMinded\Carson\Dependency\Http\Client\Exception\RequestException;
use BoldMinded\Carson\Dependency\Http\Client\HttpAsyncClient;
use BoldMinded\Carson\Dependency\Http\Discovery\Psr17Factory;
use BoldMinded\Carson\Dependency\Http\Discovery\Psr17FactoryDiscovery;
use BoldMinded\Carson\Dependency\Nyholm\Psr7\Factory\Psr17Factory as NyholmPsr17Factory;
use BoldMinded\Carson\Dependency\Nyholm\Psr7\Request;
use BoldMinded\Carson\Dependency\Nyholm\Psr7\Uri;
use BoldMinded\Carson\Dependency\Psr\Http\Client\ClientInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\RequestFactoryInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\RequestInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\ResponseFactoryInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\ResponseInterface as Psr7ResponseInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\StreamFactoryInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\StreamInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\UriFactoryInterface;
use BoldMinded\Carson\Dependency\Psr\Http\Message\UriInterface;
use BoldMinded\Carson\Dependency\Symfony\Component\HttpClient\Internal\HttplugWaitLoop;
use BoldMinded\Carson\Dependency\Symfony\Component\HttpClient\Response\HttplugPromise;
use BoldMinded\Carson\Dependency\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface;
use BoldMinded\Carson\Dependency\Symfony\Contracts\HttpClient\HttpClientInterface;
use BoldMinded\Carson\Dependency\Symfony\Contracts\HttpClient\ResponseInterface;
use BoldMinded\Carson\Dependency\Symfony\Contracts\Service\ResetInterface;
