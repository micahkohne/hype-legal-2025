 ...
 */
use BoldMinded\Carson\Dependency\Symfony\Polyfill\Php83 as p;
if (\PHP_VERSION_ID >= 80300) {
    return;
}
if (!\function_exists('BoldMinded\\Carson\\Dependency\\json_validate')) {
...
if (\extension_loaded('mbstring')) {
    if (!\function_exists('BoldMinded\\Carson\\Dependency\\mb_str_pad')) {
...
if (!\function_exists('BoldMinded\\Carson\\Dependency\\stream_context_set_options')) {
    function stream_context_set_options($context, array $options) : bool
    {
        return \stream_context_set_option($context, $options);
    }
}
if (!\function_exists('BoldMinded\\Carson\\Dependency\\str_increment')) {
    function str_increment(string $string) : string
    {
        return p\Php83::str_increment($string);
    }
}
if (!\function_exists('BoldMinded\\Carson\\Dependency\\str_decrement')) {
...
if (!\function_exists('BoldMinded\\Carson\\Dependency\\ldap_exop_sync') && \function_exists('ldap_exop')) {
...
if (!\function_exists('BoldMinded\\Carson\\Dependency\\ldap_connect_wallet') && \function_exists('ldap_connect')) {
    function ldap_connect_wallet(?string $uri, string $wallet, string $password, int $auth_mode = \GSLC_SSL_NO_AUTH)
    {
