...
namespace BoldMinded\Carson\Dependency\Http\Discovery\Composer;

use BoldMinded\Carson\Dependency\Composer\Composer;
use BoldMinded\Carson\Dependency\Composer\DependencyResolver\Pool;
use BoldMinded\Carson\Dependency\Composer\EventDispatcher\EventSubscriberInterface;
use BoldMinded\Carson\Dependency\Composer\Factory;
use BoldMinded\Carson\Dependency\Composer\Installer;
use BoldMinded\Carson\Dependency\Composer\IO\IOInterface;
use BoldMinded\Carson\Dependency\Composer\Json\JsonFile;
use BoldMinded\Carson\Dependency\Composer\Json\JsonManipulator;
use BoldMinded\Carson\Dependency\Composer\Package\Locker;
use BoldMinded\Carson\Dependency\Composer\Package\Version\VersionParser;
use BoldMinded\Carson\Dependency\Composer\Package\Version\VersionSelector;
use BoldMinded\Carson\Dependency\Composer\Plugin\PluginInterface;
use BoldMinded\Carson\Dependency\Composer\Repository\InstalledRepositoryInterface;
use BoldMinded\Carson\Dependency\Composer\Repository\RepositorySet;
use BoldMinded\Carson\Dependency\Composer\Script\Event;
use BoldMinded\Carson\Dependency\Composer\Script\ScriptEvents;
use BoldMinded\Carson\Dependency\Composer\Util\Filesystem;
...
class Plugin implements PluginInterface, EventSubscriberInterface
{
    ...
    private const INTERFACE_MAP = ['php-http/async-client-implementation' => ['BoldMinded\\Carson\\Dependency\\Http\\Client\\HttpAsyncClient'], 'php-http/client-implementation' => ['BoldMinded\\Carson\\Dependency\\Http\\Client\\HttpClient'], 'psr/http-client-implementation' => ['BoldMinded\\Carson\\Dependency\\Psr\\Http\\Client\\ClientInterface'], 'psr/http-factory-implementation' => ['BoldMinded\\Carson\\Dependency\\Psr\\Http\\Message\\RequestFactoryInterface', 'BoldMinded\\Carson\\Dependency\\Psr\\Http\\Message\\ResponseFactoryInterface', 'BoldMinded\\Carson\\Dependency\\Psr\\Http\\Message\\ServerRequestFactoryInterface', 'BoldMinded\\Carson\\Dependency\\Psr\\Http\\Message\\StreamFactoryInterface', 'BoldMinded\\Carson\\Dependency\\Psr\\Http\\Message\\UploadedFileFactoryInterface', 'BoldMinded\\Carson\\Dependency\\Psr\\Http\\Message\\UriFactoryInterface']];
    ...
    public function getMissingRequires(InstalledRepositoryInterface $repo, array $requires, bool $isProject, array $pinnedAbstractions) : array
    {
        ...
        if (ClassDiscovery::safeClassExists(\BoldMinded\Carson\Dependency\Phalcon\Http\Message\RequestFactory::class, \false)) {
