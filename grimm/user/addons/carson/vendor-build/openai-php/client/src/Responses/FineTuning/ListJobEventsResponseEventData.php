...
final class ListJobEventsResponseEventData implements ResponseContract
{
     ...
     */
    use ArrayAccessible;
    private function __construct(public readonly int $step, public readonly float $trainLoss, public readonly float $trainMeanTokenAccuracy)
    {
    }
    /**
    ...
    {
        return ['step' => $this->step, 'train_loss' => $this->trainLoss, 'train_mean_token_accuracy' => $this->trainMeanTokenAccuracy];
    }
}
