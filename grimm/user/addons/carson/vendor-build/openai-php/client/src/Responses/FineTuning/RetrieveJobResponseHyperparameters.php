...
final class RetrieveJobResponseHyperparameters implements ResponseContract
{
     ...
     */
    use ArrayAccessible;
    private function __construct(public readonly int|string $nEpochs, public readonly int|string|null $batchSize, public readonly float|string|null $learningRateMultiplier)
    {
    }
    /**
    ...
    {
        return new self($attributes['n_epochs'], $attributes['batch_size'], $attributes['learning_rate_multiplier']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['n_epochs' => $this->nEpochs, 'batch_size' => $this->batchSize, 'learning_rate_multiplier' => $this->learningRateMultiplier];
    }
}
