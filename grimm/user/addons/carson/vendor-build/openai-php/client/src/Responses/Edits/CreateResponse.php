...
namespace BoldMinded\Carson\Dependency\OpenAI\Responses\Edits;
...
final class CreateResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     */
    private function __construct(public readonly string $object, public readonly int $created, public readonly array $choices, public readonly CreateResponseUsage $usage, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    public static function from(array $attributes, MetaInformation $meta) : self
    {
        ...
        return new self($attributes['object'], $attributes['created'], $choices, CreateResponseUsage::from($attributes['usage']), $meta);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['object' => $this->object, 'created' => $this->created, 'choices' => \array_map(static fn(CreateResponseChoice $result): array => $result->toArray(), $this->choices), 'usage' => $this->usage->toArray()];
    }
}
