...
{
    private function __construct(public readonly ?string $model, public readonly ?string $organization, public readonly ?string $version, public readonly ?int $processingMs)
    {
    }
    /**
