...
final class ThreadRunStepResponseRetrievalToolCall implements ResponseContract
{
     ...
     */
    private function __construct(public string $id, public string $type, public array $retrieval)
    {
    }
    /**
    ...
    {
        return new self($attributes['id'], $attributes['type'], $attributes['retrieval']);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['id' => $this->id, 'type' => $this->type, 'retrieval' => $this->retrieval];
    }
}
