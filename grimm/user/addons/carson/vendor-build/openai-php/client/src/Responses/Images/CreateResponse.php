...
final class CreateResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        $results = \array_map(fn(array $result): CreateResponseData => CreateResponseData::from($result), $attributes['data']);
    ...
    {
        return ['created' => $this->created, 'data' => \array_map(static fn(CreateResponseData $result): array => $result->toArray(), $this->data)];
    }
}
