...
final class ThreadRunStepResponseCodeToolCall implements ResponseContract
{
    ...
    {
        return new self($attributes['id'], $attributes['type'], ThreadRunStepResponseCodeInterpreter::from($attributes['code_interpreter']));
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['id' => $this->id, 'type' => $this->type, 'code_interpreter' => $this->codeInterpreter->toArray()];
    }
}
