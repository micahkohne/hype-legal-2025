...
namespace BoldMinded\Carson\Dependency\OpenAI\Responses\Threads\Messages;
...
final class ThreadMessageResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     */
    private function __construct(public string $id, public string $object, public int $createdAt, public string $threadId, public string $role, public array $content, public ?string $assistantId, public ?string $runId, public array $fileIds, public array $metadata, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    {
        $content = \array_map(fn(array $content): \BoldMinded\Carson\Dependency\OpenAI\Responses\Threads\Messages\ThreadMessageResponseContentTextObject|\BoldMinded\Carson\Dependency\OpenAI\Responses\Threads\Messages\ThreadMessageResponseContentImageFileObject => match ($content['type']) {
        ...
        return new self($attributes['id'], $attributes['object'], $attributes['created_at'], $attributes['thread_id'], $attributes['role'], $content, $attributes['assistant_id'], $attributes['run_id'], $attributes['file_ids'], $attributes['metadata'], $meta);
    }
    /**
     * {@inheritDoc}
     */
