...
final class CreateResponseChoiceLogprobs
{
     ...
     */
    private function __construct(public readonly array $tokens, public readonly array $tokenLogprobs, public readonly ?array $topLogprobs, public readonly array $textOffset)
    {
    }
    /**
    ...
    {
        return ['tokens' => $this->tokens, 'token_logprobs' => $this->tokenLogprobs, 'top_logprobs' => $this->topLogprobs, 'text_offset' => $this->textOffset];
    }
}
