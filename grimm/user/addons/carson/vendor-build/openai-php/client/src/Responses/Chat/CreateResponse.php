...
namespace BoldMinded\Carson\Dependency\OpenAI\Responses\Chat;
...
final class CreateResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     */
    private function __construct(public readonly string $id, public readonly string $object, public readonly int $created, public readonly string $model, public readonly ?string $systemFingerprint, public readonly array $choices, public readonly CreateResponseUsage $usage, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    public static function from(array $attributes, MetaInformation $meta) : self
    {
        ...
        return new self($attributes['id'], $attributes['object'], $attributes['created'], $attributes['model'], $attributes['system_fingerprint'] ?? null, $choices, CreateResponseUsage::from($attributes['usage']), $meta);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return \array_filter(['id' => $this->id, 'object' => $this->object, 'created' => $this->created, 'model' => $this->model, 'system_fingerprint' => $this->systemFingerprint, 'choices' => \array_map(static fn(CreateResponseChoice $result): array => $result->toArray(), $this->choices), 'usage' => $this->usage->toArray()], fn(mixed $value): bool => !\is_null($value));
    }
}
