...
final class RetrieveStreamedResponseEvent implements ResponseContract
{
    ...
    private function __construct(public readonly string $object, public readonly int $createdAt, public readonly string $level, public readonly string $message)
    {
    }
    /**
    ...
    {
        return ['object' => $this->object, 'created_at' => $this->createdAt, 'level' => $this->level, 'message' => $this->message];
    }
}
