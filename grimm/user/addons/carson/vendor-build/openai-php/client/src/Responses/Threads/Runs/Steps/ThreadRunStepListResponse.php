...
final class ThreadRunStepListResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    {
        return ['object' => $this->object, 'data' => \array_map(static fn(ThreadRunStepResponse $response): array => $response->toArray(), $this->data), 'first_id' => $this->firstId, 'last_id' => $this->lastId, 'has_more' => $this->hasMore];
    }
}
