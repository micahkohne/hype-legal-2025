...
final class RetrieveResponseHyperparams implements ResponseContract
{
     ...
     */
    use ArrayAccessible;
    private function __construct(public readonly ?int $batchSize, public readonly ?float $learningRateMultiplier, public readonly int $nEpochs, public readonly float $promptLossWeight)
    {
    }
    /**
    ...
    {
        return ['batch_size' => $this->batchSize, 'learning_rate_multiplier' => $this->learningRateMultiplier, 'n_epochs' => $this->nEpochs, 'prompt_loss_weight' => $this->promptLossWeight];
    }
}
