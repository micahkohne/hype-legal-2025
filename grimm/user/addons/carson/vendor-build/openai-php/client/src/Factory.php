...
namespace BoldMinded\Carson\Dependency\OpenAI;

use Closure;
use Exception;
use BoldMinded\Carson\Dependency\GuzzleHttp\Client as GuzzleClient;
use BoldMinded\Carson\Dependency\Http\Discovery\Psr18ClientDiscovery;
use BoldMinded\Carson\Dependency\OpenAI\Transporters\HttpTransporter;
use BoldMinded\Carson\Dependency\OpenAI\ValueObjects\ApiKey;
use BoldMinded\Carson\Dependency\OpenAI\ValueObjects\Transporter\BaseUri;
use BoldMinded\Carson\Dependency\OpenAI\ValueObjects\Transporter\Headers;
use BoldMinded\Carson\Dependency\OpenAI\ValueObjects\Transporter\QueryParams;
...
use BoldMinded\Carson\Dependency\Symfony\Component\HttpClient\Psr18Client;
final class Factory
{
    /**
    ...
    private function makeStreamHandler(ClientInterface $client) : Closure
    {
        ...
        if ($client instanceof GuzzleClient) {
            return fn(RequestInterface $request): ResponseInterface => $client->send($request, ['stream' => \true]);
        }
