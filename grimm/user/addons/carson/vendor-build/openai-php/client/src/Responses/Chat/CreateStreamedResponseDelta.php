...
final class CreateStreamedResponseDelta
{
     ...
     */
    private function __construct(public readonly ?string $role, public readonly ?string $content, public readonly array $toolCalls, public readonly ?CreateStreamedResponseFunctionCall $functionCall)
    {
    }
    /**
    ...
    {
        $toolCalls = \array_map(fn(array $result): CreateStreamedResponseToolCall => CreateStreamedResponseToolCall::from($result), $attributes['tool_calls'] ?? []);
        return new self($attributes['role'] ?? null, $attributes['content'] ?? null, $toolCalls, isset($attributes['function_call']) ? CreateStreamedResponseFunctionCall::from($attributes['function_call']) : null);
    }
    /**
