...
final class ThreadRunStepResponseCodeInterpreter implements ResponseContract
{
     ...
     */
    private function __construct(public string $input, public array $outputs)
    {
    }
    /**
    ...
    {
        $outputs = \array_map(fn(array $output): \BoldMinded\Carson\Dependency\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputImage|\BoldMinded\Carson\Dependency\OpenAI\Responses\Threads\Runs\Steps\ThreadRunStepResponseCodeInterpreterOutputLogs => match ($output['type']) {
        ...
        return new self($attributes['input'], $outputs);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        return ['input' => $this->input, 'outputs' => \array_map(fn(ThreadRunStepResponseCodeInterpreterOutputImage|ThreadRunStepResponseCodeInterpreterOutputLogs $output): array => $output->toArray(), $this->outputs)];
    }
}
