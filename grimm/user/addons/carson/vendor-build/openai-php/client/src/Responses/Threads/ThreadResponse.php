...
namespace BoldMinded\Carson\Dependency\OpenAI\Responses\Threads;
...
final class ThreadResponse implements ResponseContract, ResponseHasMetaInformationContract
{
     ...
     */
    private function __construct(public string $id, public string $object, public int $createdAt, public array $metadata, private readonly MetaInformation $meta)
    {
    }
    /**
    ...
    {
        return new self($attributes['id'], $attributes['object'], $attributes['created_at'], $attributes['metadata'], $meta);
    }
    /**
     * {@inheritDoc}
     */
