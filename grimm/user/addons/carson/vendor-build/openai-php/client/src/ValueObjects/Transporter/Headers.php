...
final class Headers
{
    ...
    {
        return new self(['Authorization' => "Bearer {$apiKey->toString()}"]);
    }
    /**
    ...
    {
        return new self([...$this->headers, 'Content-Type' => $contentType->value . $suffix]);
    }
    /**
    ...
    {
        return new self([...$this->headers, 'OpenAI-Organization' => $organization]);
    }
    /**
