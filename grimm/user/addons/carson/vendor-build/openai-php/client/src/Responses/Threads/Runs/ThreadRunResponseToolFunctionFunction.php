...
final class ThreadRunResponseToolFunctionFunction implements ResponseContract
{
     ...
     */
    private function __construct(public string $name, public string $description, public array $parameters)
    {
    }
    /**
    ...
    {
        return new self($attributes['name'], $attributes['description'], $attributes['parameters']);
    }
    /**
     * {@inheritDoc}
     */
